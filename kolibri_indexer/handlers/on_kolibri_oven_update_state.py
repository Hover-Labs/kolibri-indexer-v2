...
async def on_kolibri_oven_update_state(
    ...
    oven.borrowed_tokens = Decimal(update_state.parameter.nat)
    oven.stability_fee_tokens = Decimal(update_state.parameter.int_0)
    oven.interest_index = Decimal(update_state.parameter.int_1)
